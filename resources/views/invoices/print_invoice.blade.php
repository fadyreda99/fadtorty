                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $printed->product }}</td>
                                        <td class="tx-center">{{ number_format($printed->amount_collection, 2) }}</td>
                                        <td class="tx-right">{{ number_format($printed->amount_commission, 2) }}</td>
                                        @php
                                            $total = $printed->amount_collection + $printed->amount_commission;
                                        @endphp
                                        <td class="tx-right">
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $printed->rate_vat }})</td>
                                        <td class="tx-right" colspan="2">287.50</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">قيمة الخصم</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($printed->discount, 2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبة</td>
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($printed->total, 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
