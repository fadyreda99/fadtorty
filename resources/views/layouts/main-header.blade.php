            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                            href="{{ route('markAsReadAll') }}">تعيين قراءة الكل</a></span>
                                </div>
                            ...
                            <div class="main-notification-list Notification-scroll">
                                <div id="unreadNotifications">
                                    @foreach (auth()->user()->unreadNotifications as $notification)
                                        <form method="post" action="{{ route('readNotify') }}">
                                            @csrf
                                            <input type="hidden" name="notify_id" value="{{ $notification->id }}">
                                            <input type="hidden" name="invoice_id"
                                                value="{{ $notification->data['id'] }}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/shadow.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    <img alt="" src="{{ URL::asset('assets/img/faces/shadow.png') }}"
                                        class="">
                                </div>
