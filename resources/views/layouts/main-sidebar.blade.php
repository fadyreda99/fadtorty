...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'dashboard')) }}">FATORTY</a>
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/shadow.png') }}">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">فاتورتى</li>
            <li class="slide">
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ route('categories.index') }}">الاقسام</a></li>
                        @endcan
